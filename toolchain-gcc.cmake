    ...
    if(ARCH STREQUAL "i386")
        ...
        if(CMAKE_HOST_WIN32)
            ...
            if(NOT $ENV{_ROSBE_VERSION} VERSION_LESS 2.1)
                # HACK attempt...
                set(MINGW_TOOLCHAIN_PREFIX "x86_64-linux-gnu-" CACHE STRING "AppVeyor x86_64 Toolchain Prefix")
...
if (NOT DEFINED MINGW_TOOLCHAIN_SUFFIX)
    # HACK attempt... (Default == 7.4.0)
    set(MINGW_TOOLCHAIN_SUFFIX "-8" CACHE STRING "AppVeyor GCC 8 Toolchain Suffix")
