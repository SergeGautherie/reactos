...
static UINT_PTR (WINAPI *pSHExplorerParseCmdLine)(PEXPLORER_CMDLINE_PARSE_RESULTS pInfo);
...
//        { __LINE__, L"a:\\,/select,c:\\", TRUE, PIDL_IS_PATH, 0x00000240, NULL, L"C:\\" },
    ...
    pSHExplorerParseCmdLine = (UINT_PTR (WINAPI *)(PEXPLORER_CMDLINE_PARSE_RESULTS))GetProcAddress(browseui, MAKEINTRESOURCEA(107));
